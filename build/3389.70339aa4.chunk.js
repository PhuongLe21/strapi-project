"use strict";(self.webpackChunkstrapi_project=self.webpackChunkstrapi_project||[]).push([[3389],{40216:(rt,U,s)=>{s.d(U,{S:()=>$});var t=s(92132),_=s(79793),p=s(94061),X=s(48653),E=s(83997),S=s(30893);const F=(0,_.Ay)(p.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
...
`,Pt=(0,f.Ay)(p.s)`
  ...
  justify-content: center;
  align-items: center;
`,At=({customRowComponent:e,components:n=[],addComponent:o,name:a,targetUid:c})=>{const{isInDevelopmentMode:l}=(0,r.u)(),[g,D]=(0,W.useState)(0),{formatMessage:y}=(0,I.A)(),M=i=>{g!==i&&D(i)},u=()=>{o(a)};return(0,t.jsx)(q,{className:"dynamiczone-row",isFromDynamicZone:!0,children:(0,t.jsxs)("td",{colSpan:12,children:[(0,t.jsx)(Ct,{paddingLeft:8,children:(0,t.jsxs)(Dt,{gap:2,children:[l&&(0,t.jsx)("button",{type:"button",onClick:u,children:(0,t.jsxs)(Pt,{direction:"column",alignItems:"stretch",gap:1,children:[(0,t.jsx)(jt,{}),(0,t.jsx)(E.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:y({id:(0,r.g)("button.component.add"),defaultMessage:"Add a component"})})]})}),(0,t.jsx)(p.s,{role:"tablist",gap:2,children:n.map((i,h)=>(0,t.jsx)(yt,{dzName:a||"",index:h,component:i,isActive:g===h,isInDevelopmentMode:l,onClick:()=>M(h)},i))})]})}),(0,t.jsx)(Ot,{children:n.map((i,h)=>{const m={customRowComponent:e,component:i};return(0,t.jsx)(_.a,{id:`dz-${a}-panel-${h}`,role:"tabpanel","aria-labelledby":`dz-${a}-tab-${h}`,style:{display:g===h?"block":"none"},children:(0,t.jsx)("table",{children:(0,t.jsx)("tbody",{children:(0,W.createElement)(tt,{...m,isFromDynamicZone:!0,component:c,key:i})})})},i)})})]})})},Tt=(0,f.Ay)(_.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
